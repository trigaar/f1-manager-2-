...
export * from './constants/drivers';
export * from './constants/teams';
export * from './constants/tracks';
export * from './constants/personnel';
export * from './constants/rookies';
export * from './constants/traits';
export * from './constants/trackSVGs';
...
export const FINANCIAL_CONSTANTS = {
    ...
    PRIZE_POOL_VARIATION: 0.05,
    LST_BONUS_PERCENTAGE: 0.02,
    LST_BONUS_ESCALATION_THRESHOLD: 1_600_000_000,
    LST_BONUS_ESCALATION_PERCENTAGE: 0.04,
