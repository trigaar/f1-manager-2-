    ...
    const renderContractStatus = (driver: InitialDriver) => {
        ...
        if (negotiationDriverId === driver.id) {
            return (
                <div className="mt-4 space-y-2">
                    ...
                    <button onClick={() => handleOffer(driver.id, 'Higher')} className="w-full text-sm bg-green-700 hover:bg-green-600 font-semibold py-1 px-2 rounded">Higher Offer (+20% Salary)</button>
                    <button onClick={() => handleOffer(driver.id, 'Same')} className="w-full text-sm bg-gray-600 hover:bg-gray-500 font-semibold py-1 px-2 rounded">Same Offer</button>
                    <button onClick={() => handleOffer(driver.id, 'Lower')} className="w-full text-sm bg-orange-700 hover:bg-orange-600 font-semibold py-1 px-2 rounded">Lower Offer (-20% Salary)</button>
        ...
        return (
            <>
                ...
                <button onClick={() => setNegotiationDriverId(driver.id)} className="w-full mt-4 text-sm bg-teal-600 hover:bg-teal-700 font-semibold py-2 px-3 rounded">
                    Manage Contract
                </button>
            </>
        );
